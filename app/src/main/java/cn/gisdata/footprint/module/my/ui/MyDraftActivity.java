 ...
 * 功能：
 */
public class MyDraftActivity extends BaseActivity<MyFootListPresenter, MyFootListModel> implements MyFootListContract.View {
    ...
    public static void startAction(Activity activity, boolean isFinish, int currentItem) {
        Intent intent = new Intent(activity, MyDraftActivity.class);
